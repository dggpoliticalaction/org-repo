...
The Digital Ground Game (DGG) Political Action website template built with [Payload CMS](https://payloadcms.com) and [Next.js](https://nextjs.org) for political action organizations.
...
```bash
# Build the image
docker build -t dgg-political-action .
