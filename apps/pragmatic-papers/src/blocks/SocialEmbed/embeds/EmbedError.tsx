    ...
    >
      <CardContent className="flex flex-col items-center pt-4">
        ...
        <a
          ...
          className="focus-visible:ring-ring inline-flex items-center gap-1 rounded-xs shadow-none hover:underline focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-hidden"
        >
