...
function SelectScrollUpButton({
  className,
  ...props
}: React.ComponentProps<typeof SelectPrimitive.ScrollUpArrow>): React.ReactNode {
  return (
...
function SelectScrollDownButton({
  className,
  ...props
}: React.ComponentProps<typeof SelectPrimitive.ScrollDownArrow>): React.ReactNode {
  return (
...
function SelectLabel({ className, ...props }: SelectPrimitive.GroupLabel.Props): React.ReactNode {
  return (
...
function SelectItem({
  ...
  children,
  ...props
}: SelectPrimitive.Item.Props): React.ReactNode {
  return (
...
function SelectSeparator({
  className,
  ...props
}: SelectPrimitive.Separator.Props): React.ReactNode {
  return (
