...
function Sheet({ ...props }: SheetPrimitive.Root.Props): React.ReactNode {
  return <SheetPrimitive.Root data-slot="sheet" {...props} />
}

function SheetTrigger({ ...props }: SheetPrimitive.Trigger.Props): React.ReactNode {
  return <SheetPrimitive.Trigger data-slot="sheet-trigger" {...props} />
}

function SheetClose({ ...props }: SheetPrimitive.Close.Props): React.ReactNode {
  return <SheetPrimitive.Close data-slot="sheet-close" {...props} />
}

function SheetPortal({ ...props }: SheetPrimitive.Portal.Props): React.ReactNode {
  return <SheetPrimitive.Portal data-slot="sheet-portal" {...props} />
}

function SheetOverlay({ className, ...props }: SheetPrimitive.Backdrop.Props): React.ReactNode {
  return (
...
function SheetTitle({ className, ...props }: SheetPrimitive.Title.Props): React.ReactNode {
  return (
...
function SheetDescription({
  className,
  ...props
}: SheetPrimitive.Description.Props): React.ReactNode {
  return (
