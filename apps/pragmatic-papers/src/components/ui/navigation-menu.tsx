...
function NavigationMenuPositioner({
  ...
  alignOffset = 0,
  ...props
}: NavigationMenuPrimitive.Positioner.Props): React.ReactNode {
  return (
...
function NavigationMenu({
  ...
  Pick<NavigationMenuPrimitive.Positioner.Props, 'align'>): React.ReactNode {
  return (
...
function NavigationMenuList({
  className,
  ...props
}: React.ComponentPropsWithRef<typeof NavigationMenuPrimitive.List>): React.ReactNode {
  return (
...
function NavigationMenuItem({
  className,
  ...props
}: React.ComponentPropsWithRef<typeof NavigationMenuPrimitive.Item>): React.ReactNode {
  return (
...
function NavigationMenuTrigger({
  ...
  children,
  ...props
}: NavigationMenuPrimitive.Trigger.Props): React.ReactNode {
  return (
...
function NavigationMenuContent({
  className,
  ...props
}: NavigationMenuPrimitive.Content.Props): React.ReactNode {
  return (
...
function NavigationMenuLink({
  className,
  ...props
}: NavigationMenuPrimitive.Link.Props): React.ReactNode {
  return (
...
function NavigationMenuIndicator({
  className,
  ...props
}: React.ComponentPropsWithRef<typeof NavigationMenuPrimitive.Icon>): React.ReactNode {
  return (
