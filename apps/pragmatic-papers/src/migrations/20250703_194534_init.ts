...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_volume_view_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum_pages_blocks_volume_view_relation_to" AS ENUM('volumes');
  CREATE TYPE "public"."enum_pages_hero_type" AS ENUM('none', 'pageHero', 'highImpact', 'mediumImpact', 'lowImpact');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_volume_view_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum__pages_v_blocks_volume_view_relation_to" AS ENUM('volumes');
  CREATE TYPE "public"."enum__pages_v_version_hero_type" AS ENUM('none', 'pageHero', 'highImpact', 'mediumImpact', 'lowImpact');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_articles_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__articles_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_volumes_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__volumes_v_version_status" AS ENUM('draft', 'published');
  ...
  CREATE TABLE "pages_blocks_volume_view" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"intro_content" jsonb,
  	"populate_by" "enum_pages_blocks_volume_view_populate_by" DEFAULT 'collection',
  	"relation_to" "enum_pages_blocks_volume_view_relation_to" DEFAULT 'volumes',
  ...
  CREATE TABLE "_pages_v_blocks_volume_view" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"intro_content" jsonb,
  	"populate_by" "enum__pages_v_blocks_volume_view_populate_by" DEFAULT 'collection',
  	"relation_to" "enum__pages_v_blocks_volume_view_relation_to" DEFAULT 'volumes',
  	"limit" numeric DEFAULT 6,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "volumes" (
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"_status" "enum_volumes_status" DEFAULT 'draft'
  );

  CREATE TABLE "_volumes_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	"version_title" varchar,
  	"version_volume_number" numeric,
  	"version_description" varchar,
  	"version_editors_note" jsonb,
  	"version_published_at" timestamp(3) with time zone,
  	"version_slug" varchar,
  	"version_slug_lock" boolean DEFAULT true,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	"version__status" "enum__volumes_v_version_status" DEFAULT 'draft',
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"latest" boolean,
  	"autosave" boolean
  ...
  ALTER TABLE "pages_blocks_volume_view" ADD CONSTRAINT "pages_blocks_volume_view_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_rels" ADD CONSTRAINT "pages_rels_volumes_fk" FOREIGN KEY ("volumes_id") REFERENCES "public"."volumes"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_volume_view" ADD CONSTRAINT "_pages_v_blocks_volume_view_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_rels" ADD CONSTRAINT "_pages_v_rels_volumes_fk" FOREIGN KEY ("volumes_id") REFERENCES "public"."volumes"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_volumes_v" ADD CONSTRAINT "_volumes_v_parent_id_volumes_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."volumes"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_volume_view_order_idx" ON "pages_blocks_volume_view" USING btree ("_order");
  CREATE INDEX "pages_blocks_volume_view_parent_id_idx" ON "pages_blocks_volume_view" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_volume_view_path_idx" ON "pages_blocks_volume_view" USING btree ("_path");
  ...
  CREATE INDEX "pages_rels_volumes_id_idx" ON "pages_rels" USING btree ("volumes_id");
  ...
  CREATE INDEX "_pages_v_blocks_volume_view_order_idx" ON "_pages_v_blocks_volume_view" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_volume_view_parent_id_idx" ON "_pages_v_blocks_volume_view" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_volume_view_path_idx" ON "_pages_v_blocks_volume_view" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_rels_volumes_id_idx" ON "_pages_v_rels" USING btree ("volumes_id");
  ...
  CREATE INDEX "volumes__status_idx" ON "volumes" USING btree ("_status");
  CREATE INDEX "_volumes_v_parent_idx" ON "_volumes_v" USING btree ("parent_id");
  CREATE INDEX "_volumes_v_version_version_slug_idx" ON "_volumes_v" USING btree ("version_slug");
  CREATE INDEX "_volumes_v_version_version_updated_at_idx" ON "_volumes_v" USING btree ("version_updated_at");
  CREATE INDEX "_volumes_v_version_version_created_at_idx" ON "_volumes_v" USING btree ("version_created_at");
  CREATE INDEX "_volumes_v_version_version__status_idx" ON "_volumes_v" USING btree ("version__status");
  CREATE INDEX "_volumes_v_created_at_idx" ON "_volumes_v" USING btree ("created_at");
  CREATE INDEX "_volumes_v_updated_at_idx" ON "_volumes_v" USING btree ("updated_at");
  CREATE INDEX "_volumes_v_latest_idx" ON "_volumes_v" USING btree ("latest");
  CREATE INDEX "_volumes_v_autosave_idx" ON "_volumes_v" USING btree ("autosave");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_volume_view" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_volume_view" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_volume_view_populate_by";
  DROP TYPE "public"."enum_pages_blocks_volume_view_relation_to";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_volume_view_populate_by";
  DROP TYPE "public"."enum__pages_v_blocks_volume_view_relation_to";
  ...
  DROP TYPE "public"."enum_volumes_status";
  DROP TYPE "public"."enum__volumes_v_version_status";
