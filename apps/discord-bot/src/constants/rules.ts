 ...
 **4. Zero Tolerance for Fedposting**
 ...
 **7.  Do Not Falsely or Poorly Represent the Org**
...
export class Rules {
  public static ServerRules: Rule[] = [
    ...
    },
    {
      ...
      description: "If you need assistance from a moderator, please request it by tagging <@&1385638258272108755>  or DMing <@575252669443211264> . Pinging the moderators for no reason (such as meme pinging or ghost pinging) will result in disciplinary actions."
    }
  ]
}