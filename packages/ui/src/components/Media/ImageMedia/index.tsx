    ...
    <picture className={cn(pictureClassName)}>
      {resource &&
        ...
        Object.values(resource.sizes)
          .filter(
            (resourceSize): resourceSize is ValidMediaSize =>
              !!resourceSize &&
              typeof resourceSize === 'object' &&
              'width' in resourceSize &&
              'height' in resourceSize &&
              'url' in resourceSize &&
              typeof resourceSize.width === 'number' &&
              typeof resourceSize.height === 'number' &&
              typeof resourceSize.url === 'string' &&
