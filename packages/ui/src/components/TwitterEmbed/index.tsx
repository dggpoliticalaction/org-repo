...
// TODO: Discuss with team: I extend window here because it is extended in next/third-parties/google,
// but that dependency is not being read properly in this project for whatever reason.
declare global {
  interface Window {
    twttr?: {
      widgets: {
